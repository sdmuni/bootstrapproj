...
<html lang="ko">
  ...
  <body>
    ...
    <ul class="nav nav-pills">
	  <li class="active" data-toggle="pill"><a href="#">메뉴1</a></li>
	  <li ><a href="#" data-toggle="pill">메뉴2</a></li>
	  <li ><a href="#" data-toggle="pill">메뉴3</a></li>
	</ul>
	<h2>양쪽정렬된 (Justified)</h2>
     <ul class="nav nav-tabls nav-justified">
	  <li class="active" data-toggle="tab"><a href="#">메뉴1</a></li>
	  <li ><a href="#" data-toggle="tab">메뉴2</a></li>
	  <li ><a href="#" data-toggle="tab">메뉴3</a></li>
	</ul>
